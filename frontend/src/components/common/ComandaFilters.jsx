...
<Box>
<TextField fullWidth label="Data Inicial" type="date" value={filters.data_inicio} onChange={handleInputChange('data_inicio')} size="small" />
</Box>
<Box>
<TextField fullWidth label="Data Final" type="date" value={filters.data_fim} onChange={handleInputChange('data_fim')} size="small" />
</Box>
